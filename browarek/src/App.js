    ...
    return (
      <React.Fragment>
        ...
        <Switch>
          ...
          <Route exact path="/brewerySearch" render={() => <BrewerySearch setSearchResults={this.setSearchResults}/>} />
          <Route exact path="/breweryResults" render={() => <BreweryResults results={this.state.results} />} />
